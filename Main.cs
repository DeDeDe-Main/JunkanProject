...
namespace JunkanProject
{
    ...
    {
        public const string ModGuid = "com.DeDeDeMain.SerJunkan";
        public const string ModName = "Ser Junkan";
        ...
        private void Awake()
        {
            ...
            using (var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("JunkanProject.junkanassets"))
            {
